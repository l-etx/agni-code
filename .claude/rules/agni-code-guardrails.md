...
- Preserve the current module organization.
- Respect the current test layout.

## Code Style

- Use lowercase with hyphens for file naming (e.g. `session-start.js`, `python-reviewer.md`).
